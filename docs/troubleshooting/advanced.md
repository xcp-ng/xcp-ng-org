---
heading_emoji:
  serial-console-access: thread
  xen-boot-options: gear
  reading-the-hypervisor-state: mag
  host-crashes-and-crash-dumps: boom
  when-the-host-doesnt-boot: hiking_boot
  produce-a-status-report: sos
---
