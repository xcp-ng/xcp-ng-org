...
- `xe host-param-get uuid=a0134d17-5ba9-4cd0-bf16-05cb9f180663 param-name=<param\_name>` : Retrieve custom host attributes (e.g., cpu\_info, chipset-info).   
...
- `xe sr-list` : Enumerate storage repositories, showing type and capacity.   
- `xe sr-param-list uuid=<SD\_UUID>` : Retrieve properties such as read‑only status and domain type.   
