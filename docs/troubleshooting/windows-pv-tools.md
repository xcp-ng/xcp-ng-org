---
heading_emoji:
  low-storage-performance-on-windows: snail
  windows-fails-to-boot-hangs-inaccessible_boot_device: hiking_boot
  connecting-to-guests-using-serial-console: thread
  bsod-0x3b-system_service_exception-or-0x7e-system_thread_exception_not_handled-on-newer-intel-cpus: blue_heart
  bsod-0x109-critical_structure_corruption-after-migrating-vms-on-intel-platforms: boom
  windows-fails-to-boot-after-updating: recycle
  windows-server-2019-crashes-on-amd-zen-without-bsod: zipper_mouth_face
  data-drives-showing-as-removable-in-windows: floppy_disk
  xenserver-vm-tools-not-upgrading-drivers-after-installation: no_entry_sign
  xenserver-drivers-not-receiving-updates-via-windows-update: arrows_counterclockwise
  malfunctioning-xenserver-pv-drivers: stethoscope
  windows-server-2025-hangs-randomly-with-0-cpu: ice_cube
  how-to-gather-kernel-memory-dumps-for-in-depth-troubleshooting: brain
---
