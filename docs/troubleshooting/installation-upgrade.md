---
heading_emoji:
  if-the-installer-starts-booting-up-then-crashes-or-hangs: boom
  during-installation-or-upgrade: construction
  the-installer-reports-no-disks-but-the-machine-has-a-drive: minidisc
  the-iso-installer-does-not-offer-to-upgrade-the-existing-install-xcp-ng-or-xenserver: no_good_woman
  installation-logs: scroll
  debugging-the-installer: bug
---
