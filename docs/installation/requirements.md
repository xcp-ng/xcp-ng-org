...
## :clipboard: XCP-ng System Requirements {#xcp-ng-system-requirements}
...
## :clipboard: XCP-ng Configuration Limits {#xcp-ng-configuration-limits}
...
## :clipboard: Virtual Machine Configuration Limits {#virtual-machine-configuration-limits}
...
- **Virtual Network Interface Controllers (NICs) per VM**: Up to **16**.
  XCP-ng Guest Tools may be required to reach this limit. It also depends on guest operating support.

### Other

- **Passed-through USB devices**: Up to **6**.

## :8ball: Pool Requirements {#pool-requirements}
...
## :electric_plug: Network ports and connectivity {#network-ports-and-connectivity}
