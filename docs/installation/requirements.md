...
sidebar_position: 1
heading_emoji:
  xcp-ng-system-requirements: clipboard
  xcp-ng-configuration-limits: clipboard
  virtual-machine-configuration-limits: clipboard
  pool-requirements: '8ball'
  'network-ports-and-connectivity': electric_plug
---
