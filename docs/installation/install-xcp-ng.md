...
You can download the latest installer for XCP-ng 8.3 LTS from here: [https://mirrors.xcp-ng.org/isos/8.3/xcp-ng-8.3.0-20260709.iso?https=1](https://mirrors.xcp-ng.org/isos/8.3/xcp-ng-8.3.0-20260709.iso?https=1).
...
dd if=xcp-ng-8.3.0-20260709.iso of=/dev/sdX bs=8M oflag=direct
```
...
You can download it on this URL: [https://mirrors.xcp-ng.org/isos/8.3/xcp-ng-8.3.0-20260709-netinstall.iso?https=1](https://mirrors.xcp-ng.org/isos/8.3/xcp-ng-8.3.0-20260709-netinstall.iso?https=1).

As with the regular installation ISO, write it on a USB media:

```
dd if=xcp-ng-8.3.0-20260709-netinstall.iso of=/dev/sdX bs=8M oflag=direct
```
