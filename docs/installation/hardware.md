...
## :open_book: Hardware Compatibility List (HCL) {#hardware-compatibility-list-hcl}
...
## :recycle: Supported hardware outside the HCL {#supported-hardware-outside-the-hcl}
...
## :toolbox: Alternate drivers {#alternate-drivers}
...
## :gift: Additional kernel modules {#additional-kernel-modules}
...
## :fire_engine: Alternate kernel {#alternate-kernel}
...
## :hammer_and_wrench: Tips related to specific hardware {#tips-related-to-specific-hardware}
