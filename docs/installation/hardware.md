...
sidebar_position: 5
heading_emoji:
  hardware-compatibility-list-hcl: open_book
  supported-hardware-outside-the-hcl: recycle
  alternate-drivers: toolbox
  additional-kernel-modules: gift
  alternate-kernel: fire_engine
  tips-related-to-specific-hardware: hammer_and_wrench
---
