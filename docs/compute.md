...
## :link: PCI Passthrough {#pci-passthrough}
...
## :video_game: GPU Passthrough {#gpu-passthrough}
...
## :computer_mouse: USB Passthrough {#usb-passthrough}
...
## :package: Nested Virtualization {#nested-virtualization}
...
## :thermometer: CPU Temperature on Intel {#cpu-temperature-on-intel}
...
## :panda_face: Advanced Xen {#advanced-xen}
