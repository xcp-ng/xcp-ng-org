...
sidebar_position: 8
heading_emoji:
  pci-passthrough: link
  gpu-passthrough: video_game
  vgpu: desktop_computer
  usb-passthrough: computer_mouse
  'nested-virtualization': package
  cpu-temperature-on-intel: thermometer
  advanced-xen: panda_face
---
