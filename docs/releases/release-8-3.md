...
sidebar_position: 1
heading_emoji:
  structure-of-the-document: world_map
  release-information: information_source
  install: cd
  upgrade-from-previous-releases: arrow_up
  whats-new: sparkles
  status-of-xostor-in-xcp-ng-83: file_cabinet
  deprecations-and-removals: wastebasket
