...
## :open_book: What's the "AMD EPYC performance" story? {#whats-the-amd-epyc-performance-story}
...
## :adhesive_bandage: Fix 1 (significant): uncached grant-tables {#fix-1-significant-uncached-grant-tables}
...
## :zap: Fix 2: spurious interrupts {#fix-2-spurious-interrupts}
...
## :crystal_ball: Future improvements and leads {#future-improvements-and-leads}
