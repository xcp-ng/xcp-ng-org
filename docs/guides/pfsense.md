...
## :building_construction: 1. Create VM as normal. {#1-create-vm-as-normal}
...
## :hammer_and_wrench: 2. Install Guest Utilities {#2-install-guest-utilities}
...
## :no_entry_sign: 3. Disable TX Checksum Offload {#3-disable-tx-checksum-offload}
...
## :artificial_satellite: Using Xen Orchestra {#using-xen-orchestra}
...
## :technologist: Using CLI {#using-cli}
