...
## :building_construction: Create a new Virtual Machine {#create-a-new-virtual-machine}
...
## :camera_flash: Template creation {#template-creation}
...
## :rocket: Using the template {#using-the-template}
