...
## :package: Nested XCP-ng using XCP-ng {#nested-xcp-ng-using-xcp-ng}
...
## :panda_face: Nested XCP-ng using Xen {#nested-xcp-ng-using-xen}
...
## :regional_indicator_v: Nested XCP-ng using VMware (ESXi and Workstation) {#nested-xcp-ng-using-vmware-esxi-and-workstation}
...
## :regional_indicator_h: Nested XCP-ng using Microsoft Hyper-V (Windows 10 - Windows Server 2016) {#nested-xcp-ng-using-microsoft-hyper-v-windows-10---windows-server-2016}
...
## :regional_indicator_k: Nested XCP-ng using QEMU/KVM {#nested-xcp-ng-using-qemukvm}
