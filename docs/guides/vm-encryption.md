...
## :lock: Encrypting inside the VM {#encrypting-inside-the-vm}
...
## :file_cabinet: Encrypting a shared storage repository {#encrypting-a-shared-storage-repository}
...
## :brain: Things to keep in mind {#things-to-keep-in-mind}
