...
## :desktop_computer: Example System {#example-system}
...
## :brick: Building the Second RAID {#building-the-second-raid}
...
## :minidisc: Building the Storage Repository {#building-the-storage-repository}
...
## :shaking_face: Unstable RAID Arrays When Booting {#unstable-raid-arrays-when-booting}
...
## :pushpin: Stabilizing the RAID Boot Configuration: The mdadm.conf File {#stabilizing-the-raid-boot-configuration-the-mdadmconf-file}
...
## :dna: Stabilizing the RAID Boot Configuration: The initrd Configuration {#stabilizing-the-raid-boot-configuration-the-initrd-configuration}
...
## :test_tube: Building and Testing the New initrd File {#building-and-testing-the-new-initrd-file}
...
## :recycle: Updates and Upgrades {#updates-and-upgrades}
...
## :art: More and Different {#more-and-different}
