---
heading_emoji:
  example-system: desktop_computer
  building-the-second-raid: brick
  building-the-storage-repository: minidisc
  unstable-raid-arrays-when-booting: shaking_face
  stabilizing-the-raid-boot-configuration-the-mdadmconf-file: pushpin
  stabilizing-the-raid-boot-configuration-the-initrd-configuration: dna
  building-and-testing-the-new-initrd-file: test_tube
  troubleshooting: health_worker
  updates-and-upgrades: recycle
  more-and-different: art
---
