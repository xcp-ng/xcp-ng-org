...
## :gear: Setting up automatic installation {#setting-up-automatic-installation}
...
## :arrows_counterclockwise: Setting up automatic reboot {#setting-up-automatic-reboot}
...
## :eyes: Observing the installation process {#observing-the-installation-process}
...
## :shield: Appendix: Blocking vulnerable Xen drivers with Application Control for Windows {#appendix-blocking-vulnerable-xen-drivers-with-application-control-for-windows}
