...
## :building_construction: Create a VM {#create-a-vm}
...
## :sheep: Clone or copy a VM {#clone-or-copy-a-vm}
...
## :zap: Start, stop, reboot {#start-stop-reboot}
...
## :shield: Protect a VM against accidental deletion {#protect-a-vm-against-accidental-deletion}
...
## :basket: VM groups with a start order (vApps) {#vapps}
...
## :wastebasket: Delete a VM {#delete-a-vm}
