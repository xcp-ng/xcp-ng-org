...
## :mortar_board: Two kinds of templates {#two-kinds-of-templates}
...
## :camera_flash: Create a custom template {#create-a-custom-template}
...
## :soap: Prepare the source before templating {#prepare-the-source-before-templating}
...
## :rocket: Create VMs from a template {#create-vms-from-a-template}
...
## :package: Move templates around {#move-templates-around}
...
## :wastebasket: Delete a custom template {#delete-a-custom-template}
