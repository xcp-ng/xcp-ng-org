...
## :mortar_board: The different migration types {#the-different-migration-types}
...
## :white_check_mark: Requirements and limitations {#requirements-and-limitations}
...
## :rocket: Migrate within a pool {#migrate-within-a-pool}
...
## :earth_africa: Migrate to another pool {#migrate-to-another-pool}
...
## :health_worker: When something blocks the migration {#when-something-blocks-the-migration}
