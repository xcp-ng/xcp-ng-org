...
sidebar_position: 4
heading_emoji:
  how-they-work: mortar_board
  take-a-snapshot: camera_flash
  revert-to-a-snapshot: rewind
  delete-a-snapshot: wastebasket
  scheduled-rolling-snapshots: repeat
  other-things-you-can-do-with-a-snapshot: toolbox
---
