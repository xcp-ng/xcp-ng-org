...
sidebar_position: 8
heading_emoji:
  creating-a-windows-vm: building_construction
  golden-image-with-sysprep: soap
  upgrading-windows-in-place: arrow_up
  console-access: desktop_computer
  when-windows-misbehaves: health_worker
---
