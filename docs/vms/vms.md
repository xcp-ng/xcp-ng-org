...
## :jigsaw: Supported guest operating systems {#supported-guest-operating-systems}
...
## :hammer_and_wrench: Guest Tools {#guest-tools}
...
## :window: Windows VMs {#windows-vms}
