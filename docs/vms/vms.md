...
Viridian extensions —referred to as "Viridian enlightenments" by Microsoft— are required for Windows OSes to work properly. Make sure they are enabled for your VM.
