...
sidebar_position: 6
heading_emoji:
  with-xen-orchestra: artificial_satellite
  host-level-metrics-rrds: bar_chart
  live-view-on-the-host: desktop_computer
  'netdata': satellite
  snmp-and-external-supervision: bell
  what-should-i-watch: rotating_light
---
