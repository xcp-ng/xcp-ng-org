...
## :rocket: Deploy Xen Orchestra virtual Appliance {#deploy-xen-orchestra-virtual-appliance}
...
## :coin: XOA vs XO from GitHub? {#xoa-vs-xo-from-github}
...
## :globe_with_meridians: Web UI {#web-ui}
