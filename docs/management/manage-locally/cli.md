---
heading_emoji:
  getting-help-with-xe-commands: information_source
  basic-xe-syntax: placard
  special-characters-and-syntax: mahjong
  command-types: abacus
  parameter-types: yarn
  low-level-parameter-commands: microscope
  low-level-list-commands: scroll
  secrets: speak_no_evil
---
