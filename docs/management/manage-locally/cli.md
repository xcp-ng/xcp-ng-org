...
## :information_source: Getting help with xe commands {#getting-help-with-xe-commands}
...
## :placard: Basic xe syntax {#basic-xe-syntax}
...
## :mahjong: Special characters and syntax {#special-characters-and-syntax}
...
## :abacus: Command types {#command-types}
...
## :yarn: Parameter types {#parameter-types}
...
## :microscope: Low-level parameter commands {#low-level-parameter-commands}
...
## :scroll: Low-level list commands {#low-level-list-commands}
