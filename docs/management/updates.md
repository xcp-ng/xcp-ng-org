...
heading_emoji:
  quick-start: zap
  support-cycle: recycle
  prerequisites: information_source
  get-information-about-the-updates: bulb
  precautions: children_crossing
  how-to-apply-the-updates: guide_dog
  when-to-reboot: checkered_flag
  xcp-ng-7576-and-live-migrations: fire
---
