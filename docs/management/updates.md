...
## :recycle: Support cycle {#support-cycle}
...
## :information_source: Prerequisites {#prerequisites}
...
## :bulb: Get information about the updates {#get-information-about-the-updates}
...
## :children_crossing: Precautions {#precautions}
...
## :guide_dog: How to apply the updates {#how-to-apply-the-updates}
...
## :checkered_flag: When to reboot? {#when-to-reboot}
...
## :fire: XCP-ng 7.5/7.6 and live migrations {#xcp-ng-7576-and-live-migrations}
