...
## :guide_dog: How to install {#how-to-install}
...
## :package: Up to date additional packages {#up-to-date-additional-packages}
...
## :recycle: System upgrade {#system-upgrade}
...
## :dvd: Supplemental packs {#supplemental-packs}
