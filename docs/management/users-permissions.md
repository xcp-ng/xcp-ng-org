...
## :mortar_board: The model in short {#the-model-in-short}
...
## :key: Host level: the root account {#host-level-the-root-account}
...
## :busts_in_silhouette: Xen Orchestra: users, groups and ACLs {#xen-orchestra-users-groups-and-acls}
...
## :compass: Recommended setup {#recommended-setup}
