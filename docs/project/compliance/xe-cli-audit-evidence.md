...
- `xe vdi-list sr-uuid=<SR_UUID>`: List all VDIs that belong to a particular storage repository.   
...
See other log files at [Log files](/troubleshooting/log-files) section.
   
## Further reading   
See the [xe command reference](/appendix/cli_reference) section.
