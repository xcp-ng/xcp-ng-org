...
sidebar_position: 2
heading_emoji:
  xcp-ngs-rpm-repositories: card_file_box
  stable-release-vs-development-release: balance_scale
  how-a-rpm-package-is-built-for-xcp-ng: factory
  where-discussion-happens: speech_balloon
---
