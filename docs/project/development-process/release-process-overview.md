...
## :card_file_box: XCP-ng's RPM repositories {#xcp-ngs-rpm-repositories}
...
## :balance_scale: Stable release vs development release {#stable-release-vs-development-release}
...
## :factory: How a RPM package is built for XCP-ng {#how-a-rpm-package-is-built-for-xcp-ng}
...
## :speech_balloon: Where discussion happens {#where-discussion-happens}
