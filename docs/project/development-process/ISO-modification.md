...
sidebar_position: 10
heading_emoji:
  extract-an-existing-iso-image: outbox_tray
  contents-of-the-installation-iso-image: card_index_dividers
  create-a-fully-automated-installation-image: robot
  modify-the-installer-itself: hammer_and_wrench
  change-the-list-of-installed-rpms: package
  build-a-new-iso-image-with-your-changes: cd
---
