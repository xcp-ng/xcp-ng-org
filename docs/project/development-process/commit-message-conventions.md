...
## :brick: Structure of a commit message {#structure-of-a-commit-message}
...
## :pencil2: First line: short subject {#first-line-short-subject}
...
## :white_large_square: Second line: blank {#second-line-blank}

Nothing on that line. Period. No exceptions.

## :memo: Message body: commit description {#message-body-commit-description}
...
## :foot: Message footer {#message-footer}
