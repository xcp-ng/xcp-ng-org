...
## :white_check_mark: Basic tests {#basic-tests}
...
## :truck: Live migration tests {#live-migration-tests}
...
## :ice_cube: Cold migration tests {#cold-migration-tests}
...
## :panda_face: Test the Xen hypervisor itself {#test-the-xen-hypervisor-itself}
