...
sidebar_position: 9
heading_emoji:
  what-are-kernel-modules: mortar_board
  definitions-supported-modules-alternate-modules-additional-modules: books
  module-updates: recycle
  module-package-naming-conventions: label
  versioning-of-the-rpms: '1234'
  where-the-modules-are-installed-on-the-system: round_pushpin
  how-to-use-alternate-or-additional-modules: guide_dog
  kernel-modules-for-alternate-kernels: fire_engine
---
