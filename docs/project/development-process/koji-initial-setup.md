...
## :identification_card: Certificates {#certificates}
...
## :inbox_tray: Installing koji {#installing-koji}
...
## :gear: Configuring koji {#configuring-koji}
...
## :test_tube: Test your connection {#test-your-connection}
`koji moshimoshi`. If it greats you (in any language), then your connection to the server works.

## :key: Get more permissions {#get-more-permissions}
...
## :whale: Koji in Docker container {#koji-in-docker-container}
...
## :toolbox: Useful commands {#useful-commands}
