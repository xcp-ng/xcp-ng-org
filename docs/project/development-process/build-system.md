...
heading_emoji:
  enter-koji: factory
  kojis-concepts: mortar_board
  build-and-release-process: ladder
  special-case-new-packages: new
  special-case-packages-not-built-by-us: handshake
  other-tags: label
  rpm-signing: writing_hand
  repository-generation: card_file_box
---
