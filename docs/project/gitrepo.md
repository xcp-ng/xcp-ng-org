...
## :books: Main repositories {#main-repositories}

* [https://github.com/xcp-ng/](https://github.com/xcp-ng/)

## :package: Spec files and sources for RPMs {#spec-files-and-sources-for-rpms}

* [https://github.com/xcp-ng-rpms/](https://github.com/xcp-ng-rpms/)

## :desktop_computer: XCP-ng Center {#xcp-ng-center}

* [https://github.com/xcp-ng/xenadmin](https://github.com/xcp-ng/xenadmin)

## :window: Windows Guest Tools {#windows-guest-tools}
