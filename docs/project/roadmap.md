...
![A rocketship starting up.](../../assets/img/roadmap.jpg)
</div>
...
## :building_construction: In tech preview {#in-tech-preview}
...
## :construction_worker_man: In progress {#in-progress}
...
## :labcoat: Spec/Design/PoC {#specdesignpoc}
...
## :card_file_box: Backlog {#backlog}

_This is a kind of wish list, without any priorities, where we try to put some ideas._

<div style={{textAlign: 'center'}}>
![Futuristic industrial environment with people working.](../../assets/img/backlogfuturistic.jpg)
</div>
### Compute
